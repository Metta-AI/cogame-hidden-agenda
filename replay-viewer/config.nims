...
# use-after-free fixed in hidden_agenda_replay.nim (emscripten_exit_with_live_runtime)
...
# hidden_agenda_error_len(). Aborting keeps linear memory intact, and the page reads
# hidden_agenda_stage_ptr/len afterwards to report what the runtime was doing.
switch(
  "passL",
  (&"""
  -o {distDir / "hidden_agenda_replay.js"}
  ...
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_hidden_agenda_load_replay,_hidden_agenda_frame,_hidden_agenda_input,_hidden_agenda_packet_ptr,_hidden_agenda_packet_len,_hidden_agenda_error_ptr,_hidden_agenda_error_len,_hidden_agenda_stage_ptr,_hidden_agenda_stage_len
  """).replace("\n", " ")
)
